...
- **results.csv**  
  ...
  Download results.csv: [https://github.com/Psylocibe23/MathematicalOptimizationExam/releases/download/v1/resultsv1.csv](https://github.com/user-attachments/files/20017941/results.csv)
